...
class MusicService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                NotificationCompat.Action(
                    if (::exoPlayer.isInitialized && exoPlayer.isPlaying) R.drawable.pause_24px else R.drawable.play,
                    if (::exoPlayer.isInitialized && exoPlayer.isPlaying) "Pause" else "Play",
